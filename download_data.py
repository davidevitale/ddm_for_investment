...
class MarketAnalyzer:
    ...
    def download_data(self):
        ...
        latest_start_date = max(df.index[0] for df in price_frames.values())
    ...
    def calculate_normalized_prices(self, base=100):
        ...
        self.normalized_prices = self.price_data / self.price_data.iloc[0] * base
        print("Normalized prices calculated.")
    ...
    def plot_normalized_prices(self):
        ...
        for ticker in self.normalized_prices.columns:
            # Usa .get() per una gestione sicura se un ticker non fosse nel dict
    ...
    def run_analysis(self):
        """
        Esegue l'intero flusso di analisi: download, statistiche, plot.
        """
        self.download_data()
