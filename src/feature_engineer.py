...
class FeatureEngineer:
    @staticmethod
    def add_features(df: pd.DataFrame, sma_n: int, span_n: int, main_ticker: str) -> pd.DataFrame:
        """
        ...
        out_df['EMA'] = out_df[f"{main_ticker}_Volume"].ewm(span=span_n, adjust=False).mean()
