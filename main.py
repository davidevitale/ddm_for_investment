...
if __name__ == "__main__":
    ...
    train, eval = loader.load_data()   # renamed from get_data → load_data
    ...
    train = strategy.create_signals(train)       # renamed from generate_signals → create_signals
    train_bt = strategy.execute_backtest(train)  # renamed from run_backtest → execute_backtest
